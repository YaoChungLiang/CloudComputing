...
ovs-ofctl add-flow S4 in_port=4,dl_type=0x0800,nw_proto=6,tcp_src=80,actions=output:3
ovs-ofctl add-flow S3 in_port=3,dl_type=0x0800,nw_proto=6,tcp_src=80,actions=output:1
ovs-ofctl add-flow S1 in_port=3,dl_type=0x0800,nw_proto=6,tcp_src=80,actions=output:1
